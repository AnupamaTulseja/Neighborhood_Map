...
function AppViewModel() {
    ...
    this.populateInfoWindow = function(marker, infowindow) {
        if (infowindow.marker != marker) {
            ...
            clientID = "PWYHPVP3PC3UUH5SFVPARNXFU5UGR4UNCAJNXG2CRT1SZOHR";
            clientSecret =
                "NQLBD044UFM5BKRXVN1ELLEFUWCM45XRDOFPE5XJDHLEHYLH";
...
// Makes the marker bounce animation whenever clicked
    ...
    this.initMap = function() {
        ...
        var mapOptions = {
            center: new google.maps.LatLng(37.367640, -122.043391),
            zoom: 10,
            styles: styles
        };
